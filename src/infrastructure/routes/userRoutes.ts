...
userRoutes.put('/user',(req:Request,res)=>{userController.blockUser(req,res)})
userRoutes.patch('/user',(req:Request,res)=>{userController.unblockUser(req,res)})
userRoutes.post('/updateUser',(req:Request,res)=>{userController.updateUser(req,res)})
